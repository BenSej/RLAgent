...
def hyperparameters():
    ...
    parser.add_argument('--trainsize', type=int, default=2000, help='number of training steps to take per iteration')
    parser.add_argument('--epsilon', type=float, default=0.9, help='exploration parameter')
    parser.add_argument('--gamma', type=float, default=0.7, help='discount reward factor. represents how confident a '
